...
const resultsData = [
  { id: 1, studentName: "Aarav Sharma", class: "10A", ooad: 88, cn: 90, os: 85, ai: 92 },
  { id: 2, studentName: "Riya Patel", class: "10A", ooad: 78, cn: 82, os: 80, ai: 85 },
  { id: 3, studentName: "Dev Singh", class: "10B", ooad: 95, cn: 88, os: 92, ai: 96 },
  { id: 4, studentName: "Isha Verma", class: "10B", ooad: 85, cn: 91, os: 89, ai: 87 },
  { id: 5, studentName: "Kabir Mehta", class: "10C", ooad: 72, cn: 76, os: 70, ai: 74 },
];
